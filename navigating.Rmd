...
2. More information on submitting your assignments and how they will be graded under [Submitting Assignments](#submitting-assignments), and 
...
col3 <- enframe(c("Ikigai diagrams", 
                  "finding a topic", 
                  "growth mindset", 
                  ...
                  "introduction to research skillsets",
                  "coping with failure",
                  "persuasively communicating",
                  "staying true to your values",
                  "sample proposals/resumes",
                  "techniques for persevering",
                  "enjoying our holiday!",
                  "personal statements"), name = NULL, value = "Activity")
