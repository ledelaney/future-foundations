...
Perhaps I would need to first discuss electromagnetic waves[^4] and their various frequencies; explain that listening to 91.5 FM means listening to the 91.5 megaHertz frequency; explain that the transmitter[^5] of this radio station is oscillating at 91.5 million cycles per second creating a sinusoidal waveform;[^6] explain that the music is modulated[^7] onto the waveform through variations in the instantaneous frequency (FM = Frequency Modulation) creating a carrier wave;[^8] explain that the carrier wave travels through the air and is then picked up by a receiver[^9] (your radio) which can extract the music from the modulated signal.
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">What&#39;s the dumbest beliefs you had as a child?<br><br>When I was 4-5 I swore that bird seeds grew birds, thus the name. When my parents asked me to prove it to them, I planted a pile of bird seeds.<br><br>The next day there were loads of birds where I planted the seeds, showing I was right.</p>&mdash; boo-grimm (@ExileGrimm) <a href="https://twitter.com/ExileGrimm/status/1412448161688215553?ref_src=twsrc%5Etfw">July 6, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

\

My thesis chapters mostly ask exploratory questions,[^26] but I employ various methods to approach each question. One method is referred to as "meta-analysis": gathering data from hundreds (or thousands!) of published scientific studies and synthesizing this data to determine what we know in a particular area. For other questions, I designed my own tools to gather and synthesize data from scratch. What tools? What data? All this depends on what we want to know, which depends on what question we wish to answer. Research in the humanities or creative arts may look very different than research in applied physics: so this week, we will spend time exploring various research methodologies and their utility to gather relevant information necessary to answer our questions.
...
[[SUBMIT ASSIGNMENT](mailto:Assignm.rt6qthhlv1tnkkol@u.box.com)]

[^4]: [Wikipedia: Radio wave](https://en.wikipedia.org/wiki/Radio_wave)
[^5]: [Wikipedia: Transmitter](https://en.wikipedia.org/wiki/Transmitter)
[^6]: [Wikipedia: Waveform](https://en.wikipedia.org/wiki/Waveform)
[^7]: [Wikipedia: Modulation](https://en.wikipedia.org/wiki/Modulation)
[^8]: [Wikipedia: Carrier wave](https://en.wikipedia.org/wiki/Carrier_wave)
[^9]: [Wikipedia: Radio receiver](https://en.wikipedia.org/wiki/Radio_receiver)
[^26]: remember: _What is the phylogenetic distribution and frequency of self-incompatibility in Fabaceae?_