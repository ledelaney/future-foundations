...
You don't need to read the entire thing, but review the parts on the job search and on resumes/CVs/references. Do a little research on Indeed or other job boards to see what kind of jobs are open in your area of interest. Note required and preferred experience.
...
I feel you! Read the article below and any of the materials above, or do some research on career opportunities in your area of interest. Send me the URLs of any new articles you find.

+ Article: ["Picking your professional path"](https://e2eml.school/professional_path.html)

## Do

_Due no later than Thursday, November 11 at 11:59p_

This week you will sketch out a timeline, working backwards from what you plan on doing after college. Based on our reading and conversation in class, you should have a rough idea of the steps you'll need to take. You will turn in a document that has a list of activities that need to be accomplished each semester before you graduate.

Let's say you plan on entering the job market and you want to secure a job the summer after graduation. You would need to figure out the required and preferred qualifications for the job you'd like, and then figure out ideas about how you will get that experience in the next 1-2 years. You'll need recommendations, a resume, and you'll need to practice your interview skills. If grad school is your game, this will include requesting faculty recommendation letters, preparing applications, and taking GREs (if necessary).

\

**Name of Assignmemt:** LASTNAME-Timeline (submit as PDF, Word Document, or text file)  

[[SUBMIT ASSIGNMENT](mailto:Assignm.q1por5lagle4n232@u.box.com)]
